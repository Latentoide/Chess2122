...
public class Board extends TableLayout {
    ...
    public Board(Context context, AttributeSet attrs) {
        super(context, attrs);
        cells = new HashMap<>();
        Deletedpanel whitePanel = findViewById(R.id.White);
        Deletedpanel blackPanel = findViewById(R.id.Black);
        deletedPieceManager = new MyDeletePieceManager(whitePanel,blackPanel);
